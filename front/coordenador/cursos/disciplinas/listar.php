    ...
    <div class="container">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarsExample09">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link inactive" aria-current="page" href="#">Disciplinas</a>
              </li>
            </ul>
      ...
      <div class="card shadow-sm" style="margin-top: 60px;">
        <div class="card-header bg-secondary text-white fs-4 d-flex justify-content-between align-items-center">
          <span>Cursos</span>
          <a href="cadastrar.php" class="btn btn-primary"><i class="bi bi-plus-square"></i> Cadastrar Disciplina</a>
        </div>
